      ...
      <div className="w-full sm:w-[80%] md:w-[60%] lg:w-[33%] max-w-[40%] flex justify-center">
        <div className="flex justify-center items-center gap-4 w-full">
          ...
          >
            <input
              type="text"
              className="rounded-lg w-full sm:w-[400px] md:w-[500px] lg:w-[500px] h-[50px] sm:h-[55px] md:h-[60px] p-2 text-lg outline-none border-none overflow-hidden bg-gray-200 text-gray-900 resize-none whitespace-normal"
              value={message}
            ...
            <button
              type="submit"
              className="p-3 rounded-full bg-blue-500 text-white transition-all active:shadow-inner active:shadow-white active:scale-110"
              onClick={sendchat}
            >
              <i
